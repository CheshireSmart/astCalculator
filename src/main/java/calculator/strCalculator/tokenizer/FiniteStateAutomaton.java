...
public class FiniteStateAutomaton {
	...
	private TreeMap<Character,State> nextState = new TreeMap<Character,State>();
    ...
    private TreeMap<Integer,State> states = new TreeMap<Integer,State>();
	...
	legalChars.add(c);
	//Logger.info(legalChars.toString());
    }
